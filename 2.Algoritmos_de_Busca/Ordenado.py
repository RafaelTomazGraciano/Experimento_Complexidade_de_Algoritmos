...
medias, desvios_padroes = processar_dados("IteracoesMedioCasoOrdenado.txt", quant)

with open("IteracoesPiorCasoOrdenado.txt", 'r') as arquivo:
    linhas = arquivo.readlines()
...
plt.title('Quantidade de Vezes - Busca Ordenado')
