...
medias, desvios_padroes = processar_dados("IteracoesMedioCasoBinario.txt", quant)

medias_pior, x = processar_dados("IteracoesPiorCasoBinario.txt", quant);
...
plt.title('Quantidade de Vezes - Busca Binario')
