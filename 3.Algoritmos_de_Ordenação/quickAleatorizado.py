...
medias = processar_dados('QuickSortAleatorizadoIteracoes.txt', quant)
...
plt.yticks(ticks=range(0, int(max(medias)) + 1, int(max(medias) / 10)))
...
plt.title('Quick Sort Aleatorizado')
